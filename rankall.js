function showSpinner() {
  ...
  worker.postMessage({
    urls: [
      'https://datamb.football/database/CURRENT/PRO2627/GK/GK.xlsx',
      'https://datamb.football/database/CURRENT/PRO2026/GK/GK.xlsx',
      'https://datamb.football/database/CURRENT/TOP72627/GK/GK.xlsx',
      'https://datamb.football/database/CURRENT/PRO2627/CB/CB.xlsx',
      'https://datamb.football/database/CURRENT/PRO2026/CB/CB.xlsx',
      'https://datamb.football/database/CURRENT/TOP72627/CB/CB.xlsx',
      'https://datamb.football/database/CURRENT/PRO2627/FB/FB.xlsx',
      'https://datamb.football/database/CURRENT/PRO2026/FB/FB.xlsx',
      'https://datamb.football/database/CURRENT/TOP72627/FB/FB.xlsx',
      'https://datamb.football/database/CURRENT/PRO2627/CM/CM.xlsx',
      'https://datamb.football/database/CURRENT/PRO2026/CM/CM.xlsx',
      'https://datamb.football/database/CURRENT/TOP72627/CM/CM.xlsx',
      'https://datamb.football/database/CURRENT/PRO2627/FW/FW.xlsx',
      'https://datamb.football/database/CURRENT/PRO2026/FW/FW.xlsx',
      'https://datamb.football/database/CURRENT/TOP72627/FW/FW.xlsx',
      'https://datamb.football/database/CURRENT/PRO2627/ST/ST.xlsx',
      'https://datamb.football/database/CURRENT/PRO2026/ST/ST.xlsx',
  ...
  worker.onmessage = function (event) {
    if (event.data.type === 'complete') {
      ...
      document.getElementById('loadingContainer').style.display = 'none';
        ...
        const leagues = {  
          ...
          "Brazil Serie A": ["Bahia", "Botafogo", "Corinthians", "Ceará", "Sport Recife", "Cruzeiro", "Santos", "Flamengo", "Fluminense", "Fortaleza", "Grêmio", "Internacional", "Juventude", "Mirassol", "Palmeiras", "Red Bull Bragantino", "São Paulo", "Vasco da Gama", "Vitória", "Atlético Mineiro", "Athletico Paranaense", "Chapecoense", "Coritiba", "Remo"],
          
          "Argentina Primera": ["Vélez Sarsfield", "Lanús", "Godoy Cruz", "Racing Club", "Talleres Córdoba", "Platense", "Independiente", "Atlético Tucumán", "Newell's Old Boys", "River Plate", "Boca Juniors", "Gimnasia La Plata", "Unión Santa Fe", "Sarmiento", "Barracas Central", "Rosario Central", "Independiente Rivadavia", "Tigre", "Deportivo Riestra", "Banfield", "Huracán", "Argentinos Juniors", "San Martín San Juan", "Aldosivi", "Central Córdoba SdE", "Defensa y Justicia", "Estudiantes", "San Lorenzo", "Belgrano", "Instituto", "Estudiantes Río Cuarto", "Gimnasia Mendoza"],
          
          "Colombia": ["Millonarios", "Atlético Nacional", "Tolima", "Atlético Bucaramanga", "Medellín", "Fortaleza (COL)", "Once Caldas", "Santa Fe", "América de Cali", "Llaneros", "Águilas Doradas", "Deportivo Pereira", "Boyacá Chicó", "La Equidad", "Inter Bogotá", "Deportivo Pasto", "Unión Magdalena", "Alianza", "Envigado", "Deportivo Cali", "Junior", "Cúcuta Deportivo", "Jaguares de Córdoba"],
          
          "Ecuador": ["Barcelona (ECU)", "Orense", "Técnico Universitario", "Emelec", "Mushuc Runa", "Aucas", "Universidad", "Delfin", "El Nacional", "LDU Quito", "Manta", "Macará", "Deportivo Cuenca", "Libertad (ECU)", "Vinotinto de Ecuador", "Independiente del Valle", "Guayaquil City", "Leones del Norte"],
          
          "Chile": ["Universidad de Chile", "O'Higgins", "Unión Española", "Audax Italiano", "Palestino", "Ñublense", "Everton (CHI)", "La Serena", "Cobresal", "Deportes Iquique", "Coquimbo Unido", "Universidad Católica", "Unión La Calera", "Huachipato", "Deportes Limache", "Colo Colo", "Concepción", "Univ. Concepción"],
          
          "Paraguay": ["Nacional Asunción", "Libertad", "Guaraní", "Sportivo Trinidense", "Cerro Porteño", "Deportivo Recoleta", "Sportivo Ameliano", "Sportivo Luqueño", "2 de Mayo", "General Caballero JLM", "Atlético Tembetary", "Olimpia", "Rubio Ñú", "Sportivo San Lorenzo", "Club Libertad"],
          
          "Uruguay Primera": ["Defensor Sporting", "Liverpool (URU)", "Nacional (URU)", "Peñarol", "Progreso", "Torque", "Miramar Misiones", "River Plate (URU)", "Plaza Colonia", "Juventud", "Cerro", "Danubio", "Racing", "Boston River", "Cerro Largo", "Wanderers", "Albion", "Central Español", "Deportivo Maldonado"],
          
          "Norway Eliteserien": ["Brann", "Fredrikstad", "HamKam", "Haugesund", "KFUM", "Kristiansund", "Molde", "Rosenborg", "Sandefjord", "Sarpsborg 08", "Strømsgodset", "Tromsø", "Vålerenga", "Viking", "Bryne", "Bodø / Glimt", "Aalesund", "Start", "Lillestrøm"],
          
          "Sweden Allsvenskan": ["Brommapojkarna", "Djurgården", "Elfsborg", "GAIS", "Häcken", "Halmstad", "Hammarby", "IFK Göteborg", "Degerfors", "IFK Norrköping", "Malmö FF", "Mjällby", "Sirius", "Värnamo", "Öster", "AIK", "Kalmar", "Västerås SK", "Örgryte"],
          
          "K League 1": ["Ulsan Hyundai", "Jeju SK", "Daejeon Citizen", "Seoul", "Pohang Steelers", "Gimcheon Sangmu", "Gwangju", "Suwon", "Gangwon", "Daegu", "Anyang", "Jeonbuk Motors", "Bucheon 1995", "Incheon United"],
          ...
          "Segunda Division": ["Albacete", "Almería", "Burgos", "Castellón", "Celta Fortuna", "Ceuta", "Cádiz", "Córdoba", "Eibar", "Eldense", "FC Andorra", "Girona", "Granada", "Las Palmas", "Leganés", "Mallorca", "Real Oviedo", "Real Sociedad B", "Real Valladolid", "Sabadell", "Sporting Gijón", "Tenerife"],
          
          "Bundesliga 2": ["Arminia Bielefeld", "Hertha BSC", "Kaiserslautern", "Darmstadt 98", "Magdeburg", "Holstein Kiel", "Dynamo Dresden", "Eintracht Braunschweig", "Greuther Fürth", "Hannover 96", "Nürnberg", "Karlsruher SC", "Bochum", "Osnabrück", "Wolfsburg", "St. Pauli", "Heidenheim", "Energie Cottbus"],
          
          "Serie B": ["Palermo", "Virtus Entella", "Empoli", "Sampdoria", "Avellino", "Juve Stabia", "Padova", "Cesena", "Mantova", "Südtirol", "Cremonese", "Pisa", "Catanzaro", "Vicenza", "Ascoli", "Benevento", "Arezzo", "Carrarese", "Modena", "Hellas Verona"],
          
          "Ligue 2": ["Boulogne", "Nancy", "Montpellier", "Pau", "Guingamp", "Rodez", "Annecy", "Red Star", "Dunkerque", "Grenoble", "Reims", "Laval", "Saint-Étienne", "Clermont", "Dijon", "Rodez ", "Metz", "Nantes", "Sochaux"],
          
          "Liga Portugal 2": ["Benfica II", "Chaves", "Farense", "Feirense", "Felgueiras 1932", "Leixões", "Lusitania FC Lourosa", "Penafiel", "Portimonense", "Porto II", "Sporting CP II", "Torreense", "União de Leiria", "Vizela", "AVS", "Académica", "Amarante", "Tondela", "AVS "],
          
          "League One": ["AFC Wimbledon", "Barnsley", "Blackpool", "Bradford City", "Burton Albion", "Doncaster Rovers", "Huddersfield Town", "Leyton Orient", "Sheffield Wednesday", "Bromley", "Cambridge United", "Luton Town", "Mansfield Town", "Peterborough United", "Plymouth Argyle", "Reading", "Stevenage", "Stockport County", "Wigan Athletic", "Wycombe Wanderers", "Leicester City", "Oxford United", "Milton Keynes Dons", "Notts County"],
          
          "Eerste Divisie": ["AZ II", "Ajax II", "Almere City", "De Graafschap", "Den Bosch", "Dordrecht", "Eindhoven", "Emmen", "Helmond Sport", "MVV", "PSV II", "RKC Waalwijk", "Roda JC", "TOP Oss", "Utrecht II", "VVV Venlo", "Vitesse", "Volendam", "Heracles", "NAC Breda"],
          
          "Scotland Premiership": ["Rangers", "Celtic", "Hibernian", "Hearts", "Aberdeen", "Kilmarnock", "Dundee United", "Falkirk", "St. Mirren", "Dundee", "Motherwell", "St. Johnstone"],
          
          "Belgium Pro League": ["Cercle Brugge", "OH Leuven", "Union Saint-Gilloise", "Club Brugge", "Genk", "Gent", "Antwerp", "Zulte-Waregem", "La Louvière", "Standard Liège", "Sint-Truiden", "Westerlo", "Mechelen", "Anderlecht", "Charleroi", "Kortrijk", "SK Beveren", "Lommel SK"],
          
          "Swiss Super League": ["Lugano", "Young Boys", "Thun", "St. Gallen", "Grasshopper", "Lausanne Sport", "Sion", "Zürich", "Servette", "Basel", "Luzern", "Vaduz"],
          
          "Austrian Bundesliga": ["Sturm Graz", "LASK", "Salzburg", "Rapid Wien", "Hartberg", "Wolfsberger AC", "Rheindorf Altach", "WSG Swarovski Tirol", "Austria Wien", "Grazer AK", "Ried", "Austria Lustenau"],
          
          "Denmark Superliga": ["Brøndby", "Viborg", "Nordsjælland", "København", "Midtjylland", "Sønderjyske", "Silkeborg", "Randers", "OB", "AGF", "Horsens", "Lyngby", "SønderjyskE"],
          
          "Czech Fortuna Liga": ["Sparta Praha", "Viktoria Plzeň", "Hradec Králové", "Teplice", "Baník Ostrava", "Mladá Boleslav", "Slovan Liberec", "Pardubice", "Sigma Olomouc", "Zlín", "Slovácko", "Bohemians 1905", "Jablonec", "Slavia Praha", "Artis Brno", "Zbrojovka Brno"],
          
          "Serbia SuperLiga": ["Partizan", "Radnički Niš", "Radnik Surdulica", "Crvena Zvezda", "OFK Beograd", "Vojvodina", "Novi Pazar", "Radnički Kragujevac", "Čukarički", "Mladost Lučani", "Železničar Pancevo", "IMT Novi Beograd", "Mačva Šabac", "Zemun"],
          
          "Croatia HNL": ["Hajduk Split", "Dinamo Zagreb", "Osijek", "Istra 1961", "Rijeka", "Varaždin", "Slaven Belupo", "Lokomotiva Zagreb", "Gorica", "Rudeš"],
          
          "Greece": ["PAOK", "Panathinaikos", "Olympiacos Piraeus", "AEK Athens", "Panetolikos FC", "OFI", "Atromitos", "Aris", "Volos NFC", "Asteras Tripolis", "Levadiakos", "Kifissia", "Kalamata", "Iraklis 1908"],
          
          "Ukraine": ["Shakhtar Donetsk", "Dynamo Kyiv", "Polissya", "Kryvbas KR", "Zorya", "Veres", "Obolon", "Epitsentr Kamyanets-Podilskyi", "LNZ Cherkasy", "Kudrivka", "Karpaty", "Kolos Kovalivka", "Chornomorets", "Bukovyna", "Livyi Bereh", "FC Kharkiv"],
          
          "Poland": ["Cracovia Kraków", "Pogoń Szczecin", "Lech Poznań", "Korona Kielce", "Legia Warszawa", "Zagłębie Lubin", "Jagiellonia Białystok", "Widzew Łódź", "Raków Częstochowa", "Piast Gliwice", "Wisła Płock", "Katowice", "Motor Lublin", "Górnik Zabrze", "Radomiak Radom", "Wieczysta Kraków", "Wisła Kraków", "Śląsk Wrocław"],
          
          "Russia": ["Lokomotiv Moskva", "Spartak Moskva", "Krylya Sovetov", "CSKA Moskva", "Zenit", "Krasnodar", "Orenburg", "Rubin Kazan'", "Dinamo Moskva", "Akhmat Grozny", "Fakel", "Akron Togliatti", "Dynamo Makhachkala", "Rostov", "Baltika", "Rodina Moskva"],
          
          "Israel": ["Hapoel Haifa", "Hapoel Petah Tikva", "Ironi Kiryat Shmona", "Beitar Jerusalem", "Hapoel Jerusalem", "Maccabi Tel Aviv", "Hapoel Tel Aviv", "Bnei Sakhnin", "Hapoel Be'er Sheva", "Maccabi Netanya", "Ironi Tiberias", "Maccabi Haifa", "Maccabi Petah Tikva", "Hapoel Ramat Gan"],
          
          "Süper Lig": ["Fenerbahçe", "Trabzonspor", "İstanbul Başakşehir", "Rizespor", "Göztepe", "Eyüpspor", "Galatasaray", "Beşiktaş", "Samsunspor", "Konyaspor", "Kasımpaşa", "Gaziantep", "Kocaelispor", "Gençlerbirliği", "Alanyaspor", "Amed SK", "Erzurumspor FK", "Çorum FK"],
          
          "Saudi Pro League": ["Al Nassr", "Al Ittihad (KSA)", "Al Hilal", "Al Ahli", "Al Qadisiyah", "Al Taawon", "Al Ettifaq", "Al Hazem", "Al Khaleej", "Al Shabab", "Al Fateh", "Al Kholood", "Al Riyadh", "Al Feiha", " NEOM", " NEOM ", "NEOM ", "NEOM", "Al Draih", "Al Faisaly", "Abha"],
          
          "LigaMX": ["América", "Cruz Azul", "Santos Laguna", "Necaxa", "Pachuca", "Guadalajara", "Monterrey", "Toluca", "Atlas", "Club Tijuana", "Puebla", "Atlético de San Luis", "Juárez", "Tigres UANL", "Pumas UNAM", "Querétaro", "León", "Atlante"],
          
          "J1 League": ["Kashiwa Reysol", "Vissel Kobe", "Machida Zelvia", "Kashima Antlers", "Tokyo", "Tokyo Verdy", "Fagiano Okayama", "Gamba Osaka", "Yokohama F. Marinos", "Avispa Fukuoka", "Kawasaki Frontale", "Cerezo Osaka", "Shimizu S-Pulse", "Urawa Reds", "Nagoya Grampus", "Kyoto Sanga", "Sanfrecce Hiroshima", "JEF United", "V-Varen Nagasaki", "Mito Hollyhock"],
          
          "Romania": ["Argeș", "Botoşani", "CFR Cluj", "Csikszereda Miercurea Ciuc", "Dinamo Bucureşti", "FCS Bucureşti", "Farul Constanţa", "Oţelul", "Petrolul 52", "Rapid Bucureşti", "UTA Arad", "Universitatea Cluj", "Universitatea Craiova", "Voluntari", "Corvinul Hunedoara", "Sepsi"],
          
          "Bulgaria": ["Arda", "Botev Plovdiv", "Botev Vratsa", "CSKA 1948 Sofia", "CSKA Sofia", "Cherno More", "Levski Sofia", "Lokomotiv Plovdiv", "Lokomotiv Sofia 1929", "Ludogorets", "Septemvri Sofia", "Slavia Sofia", "Spartak Varna", "Dunav ot Ruse"],
          
          "Hungary": ["Debrecen", "Ferencváros", "Győri ETO", "MTK", "Nyíregyháza Spartacus", "Paksi FC", "Puskás FC", "Várda SE", "Zalaegerszegi TE", "Újpest", "Vasas", "Honvéd"],
          
          "Slovakia": ["DAC", "FC Košice", "Komárno", "Podbrezová", "Ružomberok", "Skalica", "Slovan Bratislava", "Spartak Trnava", "Trenčín", "Zemplín Michalovce", "Žilina", "Dukla Banská Bystrica"],
          
          "Slovenia": ["Aluminij", "NK Bravo", "Celje", "Koper", "Maribor", "Mura", "Olimpija", "Radomlje", "Brinje-Grosuplje", "Nafta"],
          
          "Cyprus": ["AEK Larnaca", "AEK Larnaca ", "AEL", "APOEL", "Anorthosis", "Apollon", "Aris (CYP)", "Karmiotissa", "Nea Salamis", "Olympiakos", "Omonia 29th May", "Pafos", "Ypsonas",  "Omonia Nicosia", "Omonia Aradippou"],
          
          "Egypt": ["Al Ahly", "Al Ittihad", "Al Masry", "Al Mokawloon", "Ceramica", "ENPPI", "El Geish", "El Gounah", "Ghazl El Mehalla", "Modern Sport", "National Bank of Egypt", "Petrojet", "Pyramids", "Smouha", "Wadi Degla", "ZED FC", "Zamalek", "Olympic El Qanah", "Asyut Petrol", "Abu Qair Semad"],
          
          "Morocco": ["CODM Meknès", "Difaâ El Jadida", "FAR Rabat", "FUS Rabat", "Hassania Agadir", "Ittihad Tanger", "Kawkab Marrakech", "Khemis Zemamra", "Maghreb Fès", "Olympic Safi", "Olympique Dcheïra", "RSB Berkane", "Raja Casablanca", "UTS Rabat", "Wydad Casablanca", "Widad Témara", "Moghreb Tétouan", "Yacoub El Mansour", "Amal Tiznit"],
          
          "South Africa": ["AmaZulu", "Chippa United", "Durban City", "Golden Arrows", "Kaizer Chiefs", "Mamelodi Sundowns", "Marumo Gallants", "Orlando Pirates", "Polokwane City", "Richards Bay", "Sekhukhune United", "Siwelele Football Club", "Stellenbosch FC", "TS Galaxy FC", "Kruger United", "Milford"],
          
          "Australia": ["Adelaide United", "Auckland FC", "Brisbane Roar", "Central Coast Mariners", "Macarthur", "Melbourne City", "Melbourne Victory", "Newcastle Jets", "Perth Glory", "Sydney", "Wellington Phoenix", "Western Sydney Wanderers"],
          
          "UAE": ["Ajman", "Al Ain", "Al Dhafra", "Al Ittihad Kalba", "Al Jazira", "Al Nasr", "Al Sharjah", "Al Wahda", "Al Wasl", "Bani Yas", "Dubai United FC", "Hatta", "Khorfakkan", "Shabab Al Ahli Dubai"],
          
          "Qatar": ["Al Ahli (QAT)", "Al Arabi", "Al Duhail", "Al Gharafa", "Al Rayyan", "Al Sadd", "Al Sailiya", "Al Shahaniya", "Al Shamal", "Al Wakrah", "Qatar SC", "Umm Salal", "Lusail SC"]
    ...
    const leagueDisplayNames = {
      ...
      "Czech Fortuna Liga": "First League",
      "Austrian Bundesliga": "Bundesliga (AU)",
    ...
    function getSectionConfig(selectedSection, selectedPlayer, cohorts) {
      const { baseFiltered, samePositionAndLeague, samePosition, sameLeague } = cohorts;
      const configs = {
        ...
        position: {
          ...
          titleArgs: ['All Leagues', null, selectedPlayer.position, true]
        },
        positionWithMinutes: {
          dataset: samePosition,
          withMinutes: true,
          filterFn: (p, age) => p.position === selectedPlayer.position && (!age || p.age <= age),
          titleArgs: ['All Leagues', null, selectedPlayer.position]
        },
        league: {
          dataset: sameLeague,
          withMinutes: false,
        ...
        allCsv: {
          ...
          titleArgs: ['All Leagues', null, 'Player', true]
        },
        allCsvWithMinutes: {
          dataset: baseFiltered,
          withMinutes: true,
          filterFn: (p, age) => (!age || p.age <= age),
          titleArgs: ['All Leagues', null, 'Player']
        }
      };
    ...
    function displayPlayerRankings(player) {
      ...
      const sectionConfig = getSectionConfig(selectedSection, selectedPlayer, {
        baseFiltered, samePositionAndLeague, samePosition, sameLeague
      });
      if (!sectionConfig) {
